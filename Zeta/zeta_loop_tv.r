...
years <- seq.int(1980, 2021)

for (year in years) {

  # Read dataframe from csv into correct format
  filename1a <- paste("/Users/izzy/Desktop/UNI/ECM3401 Individual Literature Review and Project/zeta diversity/matrices/zeta_data_", year, sep="")
  ...
  filename2a <- paste('Desktop/ZETA_RESULTS/tv_zeta_', year, sep="")
