...
def get_description(soup):
    ...
    # content = content.split("<h2>Examples", 1)[0]
...
df_ani = pandas.read_pickle('tv_tropes_animation.pkl')
animation_tropes = list(df_ani['trope'])

with open('trope_names.pkl', 'rb') as f:
    old_tropes = pickle.load(f)

trope_names = set(animation_tropes).difference(set(old_tropes))
...
filename = 'alt_trope_titles_dict_2.pkl'
with open(filename, 'wb') as f:
    pickle.dump(alt_titles, f)

filename = 'trope_descriptions_2.pkl'
with open(filename, 'wb') as f:
    pickle.dump(descriptions, f)

filename = 'trope_descriptions_laconic_2.pkl'
with open(filename, 'wb') as f:
    pickle.dump(descriptions_short, f)

filename = 'related_tropes_2.pkl'
with open(filename, 'wb') as f:
    pickle.dump(related_tropes, f)

filename = 'non_tropes_2.pkl'
with open(filename, 'wb') as f:
