...
tv_long_500_l0 = '../topsbm/RESULTS/tv_longdesc_cluster_500topsbm_level_0_clusters.csv'
tv_long_500_l1 = '../topsbm/RESULTS/tv_longdesc_cluster_500topsbm_level_1_clusters.csv'
...
tv_long_l2 = '../topsbm/RESULTS/tv_longdesc_clustertopsbm_level_2_clusters.csv'
tv_original_500_l0 = '../topsbm/RESULTS/tv_original_500topsbm_level_0_clusters.csv'
tv_original_500_l1 = '../topsbm/RESULTS/tv_original_500topsbm_level_1_clusters.csv'
tv_original_500_l2 = '../topsbm/RESULTS/tv_original_500topsbm_level_2_clusters.csv'
...
tv_original_l2 = '../topsbm/RESULTS/tv_originaltopsbm_level_2_clusters.csv'
tv_related_500_l0 = '../topsbm/RESULTS/tv_related_community_500topsbm_level_0_clusters.csv'
tv_related_l0 = '../topsbm/RESULTS/tv_related_communitytopsbm_level_0_clusters.csv'
tv_short_500_l0 = '../topsbm/RESULTS/tv_shortdesc_cluster_500topsbm_level_0_clusters.csv'
tv_short_500_l1 = '../topsbm/RESULTS/tv_shortdesc_cluster_500topsbm_level_1_clusters.csv'
...
tv_short_l2 = '../topsbm/RESULTS/tv_shortdesc_clustertopsbm_level_2_clusters.csv'
...
analyse_clusters(tv_long_500_l0, 'tv_long_500_l0')
analyse_clusters(tv_long_500_l1, 'tv_long_500_l1')
analyse_clusters(tv_long_l0, 'tv_long_l0')
analyse_clusters(tv_long_l1, 'tv_long_l1')
analyse_clusters(tv_long_l2, 'tv_long_l2')
analyse_clusters(tv_original_500_l0, 'tv_original_500_l0')
analyse_clusters(tv_original_500_l1, 'tv_original_500_l1')
analyse_clusters(tv_original_500_l2, 'tv_original_500_l2')
analyse_clusters(tv_original_l0, 'tv_original_l0')
analyse_clusters(tv_original_l1, 'tv_original_l1')
analyse_clusters(tv_original_l2, 'tv_original_l2')
analyse_clusters(tv_related_500_l0, 'tv_related_500_l0')
analyse_clusters(tv_related_l0, 'tv_related_l0')
analyse_clusters(tv_short_500_l0, 'tv_short_500_l0')
analyse_clusters(tv_short_500_l1, 'tv_short_500_l1')
analyse_clusters(tv_short_l0, 'tv_short_l0')
analyse_clusters(tv_short_l1, 'tv_short_l1')
analyse_clusters(tv_short_l2, 'tv_short_l2')
