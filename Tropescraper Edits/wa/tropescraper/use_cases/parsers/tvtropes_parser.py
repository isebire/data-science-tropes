...
class TVTropesParser(object):
    FILM_MAIN_SEARCH = 'https://tvtropes.org/pmwiki/pmwiki.php/Main/WesternAnimation'
    TROPES_MAIN_SEARCH = 'https://tvtropes.org/pmwiki/pmwiki.php/Main/Tropes'

    BASE_FILM_URL = 'https://tvtropes.org/pmwiki/pmwiki.php/WesternAnimation/'
    BASE_MAIN_URL = 'https://tvtropes.org/pmwiki/pmwiki.php/Main/'
    BASE_LINK_URL = 'https://tvtropes.org/'

    MAIN_RESOURCE = '/Main/'
    FILM_RESOURCE = '/WesternAnimation/'
    LINK_SELECTOR = 'a'
    ...
    MEDIA_TYPES_NOT_TROPES = {'Advertising', 'AdvertisingCampaigns', 'Series', 'AsianAnimation',
                              'EasternEuropeanAnimation', 'Anime', 'PhotographyAndIllustration',
