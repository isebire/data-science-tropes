...
class TVTropesParser(object):
    FILM_MAIN_SEARCH = 'https://tvtropes.org/pmwiki/pmwiki.php/Main/AsianAnimation'
    TROPES_MAIN_SEARCH = 'https://tvtropes.org/pmwiki/pmwiki.php/Main/Tropes'

    BASE_FILM_URL = 'https://tvtropes.org/pmwiki/pmwiki.php/Animation/'
    BASE_MAIN_URL = 'https://tvtropes.org/pmwiki/pmwiki.php/Main/'
    BASE_LINK_URL = 'https://tvtropes.org/'

    MAIN_RESOURCE = '/Main/'
    FILM_RESOURCE = '/Animation/'
    LINK_SELECTOR = 'a'
    LINK_SELECTOR_INSIDE_ARTICLE = '#main-article ul li a'
    LINK_ADDRESS_SELECTOR = 'href'
    MEDIA_TYPES_NOT_TROPES = {'Advertising', 'AdvertisingCampaigns', 'Series', 'WesternAnimation',
