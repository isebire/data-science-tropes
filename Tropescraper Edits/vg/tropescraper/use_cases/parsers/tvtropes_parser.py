...
class TVTropesParser(object):
    ...
    MEDIA_TYPES_NOT_TROPES = {'Advertising', 'AdvertisingCampaigns', 'Anime', 'AsianAnimation',
                              ...
                              'TabletopRPG', 'WarGaming', 'TabletopGames', 'Series', 'Feelies', 'Machinima',
